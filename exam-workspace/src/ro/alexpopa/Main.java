...
//        hamiltonian.hamiltonian(graph, Arrays.asList(0),1,4);

//        int n = 5, k = 3;
//
//        boolean[][] graph = new boolean[n+5][n+5];
//        for(int i=1;i<=n;i++){
//            for (int j = 1; j <= n; j++) {
//                graph[i][j]=false;
//            }
...
//
//
//        KColoring kColoring = new KColoring();
//        kColoring.backtracking(new ArrayList<>(),2, k, n,graph);
//        System.out.println(kColoring.colors.toString());
    }
}
